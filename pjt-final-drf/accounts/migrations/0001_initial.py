    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='profile/%Y/%m/%d/')),
        ...
        migrations.AddField(
            model_name='user',
            name='donate',
            field=models.ManyToManyField(through='accounts.Curator', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
